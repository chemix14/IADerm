...
/**
 * History screen backed by Room LiveData.
 */
public class HistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TrendChartView trendChart = findViewById(R.id.trendChart);
        TextView tvAvgScore = findViewById(R.id.tvAvgScore);
        TextView tvTotalAnalyses = findViewById(R.id.tvTotalAnalyses);
        TextView tvTrend = findViewById(R.id.tvTrend);
        View emptyState = findViewById(R.id.emptyState);
        ChipGroup cgTimeFilter = findViewById(R.id.cgTimeFilter);

        btnBack.setOnClickListener(v -> finish());
        btnExportPdf.setOnClickListener(v -> {
            UiFeedback.shortMessage(this, R.string.capture_processing);
        ...
        viewModel.getAllAnalyses().observe(this, records -> {
        ...
        viewModel.getPdfGeneratedPath().observe(this, path -> {
            if (path != null) {
                sharePdf(path);
